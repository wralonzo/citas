      ...
      <div id="login-row" class="row justify-content-center align-items-center">
        <div id="login-column" class="col-md-6">
          <div id="login-box" class="col-md-12">
            ...
            <div class="form-group">
              <label for="registro_hospitalario">Registro Hospitalario:</label><br>
              <input type="text" name="registro_hospitalario" id="registro_hospitalario" class="form-control" value="<?php echo $usuario['registro_hospitalario']; ?>">
            </div>
            ...
            <div class="form-group">
              <label for="direccion">Dirección del Paciente:</label><br>
              <input type="text" name="direccion" id="direccion" class="form-control" value="<?php echo isset($direccion) ? $direccion : (isset($usuario['direccion']) ? $usuario['direccion'] : ''); ?>" required>
            </div>

            <div class="form-group">
              <label for="departamento">Departamento:</label><br>
              <input type="text" name="departamento" id="departamento" class="form-control" value="<?php echo isset($departamento) ? $departamento : (isset($usuario['departamento']) ? $usuario['departamento'] : ''); ?>" required>
            </div>

            <div class="form-group">
              <label for="zona">Zona:</label><br>
              <input type="text" name="zona" id="zona" class="form-control" value="<?php echo isset($zona) ? $zona : (isset($usuario['zona']) ? $usuario['zona'] : ''); ?>" required>
            </div>

            <div class="form-group">
              <label for="pais">País:</label><br>
              <input type="text" name="pais" id="pais" class="form-control" value="<?php echo isset($pais) ? $pais : (isset($usuario['pais']) ? $usuario['pais'] : ''); ?>" required>
            </div>

            <div class="form-group">
              <label for="municipio">Municipio:</label><br>
              <input type="text" name="municipio" id="municipio" class="form-control" value="<?php echo isset($municipio) ? $municipio : (isset($usuario['municipio']) ? $usuario['municipio'] : ''); ?>" required>
            </div>
