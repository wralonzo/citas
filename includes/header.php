...
<head>
    ...
    <link href="../vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <style>
        /* Estilo para el sidebar morado */
        .bg-purple {
    background: linear-gradient(to bottom, #800080, #4B0082) !important;
}

        .sidebar-light .nav-item.active a {
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-purple sidebar sidebar-light accordion" id="accordionSidebar">
  <!-- Contenido del sidebar -->
            ...
            <div class="sidebar-brand-text mx-1" style="color: white; font-weight: bold; font-size: 24px;">
            Ginecologia </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    ...
                    <span class="neon-text">Citas</span>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
                    <i class="fa fa-sticky-note" aria-hidden="true"></i>
                    <span class="neon-text">Medicinas</span>

                </a>
                <div id="collapseTen" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Ver Medicinas:</h6>
                        <a class="collapse-item" href="../views/medicinas.php">Mostrar</a>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-gray-500"> t</div>
                                    </div>
                                </a>
                                <a class="dropdown-item text-center small text-gray-500" href="#">Prueba Messages</a>
                            </div>
                        </li>
